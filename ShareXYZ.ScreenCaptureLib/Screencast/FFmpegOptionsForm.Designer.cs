namespace ShareXYZ.ScreenCaptureLib
{
    partial class FFmpegOptionsForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.eiFFmpeg = new ShareXYZ.HelpersLib.ExportImportControl();
            ...
            this.eiFFmpeg.ExportRequested += new ShareXYZ.HelpersLib.ExportImportControl.ExportEventHandler(this.eiFFmpeg_ExportRequested);
            this.eiFFmpeg.ImportRequested += new ShareXYZ.HelpersLib.ExportImportControl.ImportEventHandler(this.eiFFmpeg_ImportRequested);
            // 
            // FFmpegOptionsForm
            // 
        ...
        private ShareXYZ.HelpersLib.ExportImportControl eiFFmpeg;
