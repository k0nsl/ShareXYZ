...
using ShareXYZ.ScreenCaptureLib.Properties;
using System;
...
namespace ShareXYZ.ScreenCaptureLib
{
    public partial class FFmpegOptionsForm : BaseForm
    {
        ...
        private void btnInstallHelperDevices_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("File not exists: \"" + filepath + "\"", "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            URLHelpers.OpenURL("https://github.com/ShareXYZ/ShareXYZ/wiki/FFmpeg-options#additional-commands");
        }
        ...
        private void DownloaderForm_InstallRequested(string filePath)
        {
            ...
            if (result)
            {
                ...
                MessageBox.Show(Resources.FFmpegOptionsForm_DownloaderForm_InstallRequested_Successfully_downloaded_FFmpeg_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(Resources.FFmpegOptionsForm_DownloaderForm_InstallRequested_Download_of_FFmpeg_failed_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        {
            URLHelpers.OpenURL("https://github.com/ShareXYZ/ShareXYZ/wiki/FFmpeg-options");
        }
