    ...
    public partial class ExportImportControl : UserControl
    {
        ...
        private void tsmiExportClipboard_Click(object sender, EventArgs e)
        {
            if (ExportRequested != null)
            {
                ...
                {
                    MessageBox.Show(Resources.ExportImportControl_tsmiExportClipboard_Click_Settings_copied_to_your_clipboard_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
        }
