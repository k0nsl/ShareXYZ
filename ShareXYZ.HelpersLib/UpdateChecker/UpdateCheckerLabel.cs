            ...
            this.InvokeSafe(() =>
            {
                ...
                switch (updateChecker.Status)
                {
                    ...
                    case UpdateStatus.UpdateAvailable:
                        llblUpdateAvailable.Text = string.Format(Resources.UpdateCheckerLabel_UpdateControls_A_newer_version_of_ShareXYZ_is_available, Application.ProductName);
                        llblUpdateAvailable.Visible = true;
                        break;
                    case UpdateStatus.UpToDate:
                        lblStatus.Text = string.Format(Resources.UpdateCheckerLabel_UpdateControls_ShareXYZ_is_up_to_date, Application.ProductName);
                        lblStatus.Visible = true;
                        break;
                }
            });
