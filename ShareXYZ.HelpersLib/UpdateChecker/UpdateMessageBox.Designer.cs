namespace ShareXYZ.HelpersLib
{
    partial class UpdateMessageBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblText = new ShareXYZ.HelpersLib.BlackStyleLabel();
            this.btnNo = new ShareXYZ.HelpersLib.BlackStyleButton();
            this.btnYes = new ShareXYZ.HelpersLib.BlackStyleButton();
            this.cbDontShow = new ShareXYZ.HelpersLib.BlackStyleCheckBox();
            this.SuspendLayout();
            // 
            // lblText
            // 
