...
using ShareXYZ.ImageEffectsLib.Properties;
using System;
        ...
        private void UpdatePreview()
        {
            if (DefaultImage != null)
            {
                ...
                using (Image preview = ApplyEffects())
                {
                    ...
                    Text = string.Format("ShareXYZ - " + Resources.ImageEffectsForm_UpdatePreview_Image_effects___Width___0___Height___1___Render_time___2__ms,
