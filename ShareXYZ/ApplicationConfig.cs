...
namespace ShareXYZ
{
    public class ApplicationConfig : SettingsBase<ApplicationConfig>
    {
        ...
        [Category("Application"), DefaultValue(true), Description("Saves recent links so when ShareXYZ reopened it will remember them.")]
        ...
        [Category("Application"), DefaultValue(100), Description("Large file size defined in MiB or MB. ShareXYZ will warn before uploading large files. 0 disables this feature.")]
        ...
        [Category("Paths"), Description("Custom uploaders configuration path. If you have already configured this setting in another device and you are attempting to use the same location, then backup the file before configuring this setting and restore after exiting ShareXYZ.")]
        [Editor(typeof(DirectoryNameEditor), typeof(UITypeEditor))]
        public string CustomUploadersConfigPath { get; set; }

        [Category("Paths"), Description("Custom hotkeys configuration path. If you have already configured this setting in another device and you are attempting to use the same location, then backup the file before configuring this setting and restore after exiting ShareXYZ.")]
        [Editor(typeof(DirectoryNameEditor), typeof(UITypeEditor))]
