    ...
    internal static class Program
    {
        ...
        public static string Title
        {
            get
            {
                ...
                string title = string.Format("ShareXYZ {0}.{1}", version.Major, version.Minor);
        ...
        public static readonly string DefaultPersonalPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "ShareXYZ");
        private static readonly string PortablePersonalPath = Path.Combine(StartupPath, "ShareXYZ");
        ...
        private static readonly string LogFileName = "ShareXYZ-Log-{0:yyyy-MM}.txt";
        ...
        private static void Run()
        {
                ...
                if (!Directory.Exists(PersonalPath))
                {
                    ...
                    catch (Exception e)
                    {
                        MessageBox.Show(Resources.Program_Run_Unable_to_create_folder_ + string.Format(" \"{0}\"\r\n\r\n{1}", PersonalPath, e),
                            "ShareXYZ - " + Resources.Program_Run_Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
                        CustomPersonalPath = "";
                    }
                }
            }
            ...
            {
                DebugHelper.WriteLine("Git: https://github.com/ShareXYZ/ShareXYZ/tree/" + gitHash);
            }
            ...
            DebugHelper.WriteLine("ShareXYZ closing");
        ...
        {
            using (Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("ShareXYZ.GitHash.txt"))
