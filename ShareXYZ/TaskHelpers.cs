...
using ShareXYZ.ImageEffectsLib;
using ShareXYZ.MediaLib;
using ShareXYZ.Properties;
using ShareXYZ.ScreenCaptureLib;
using ShareXYZ.UploadersLib;
using ShareXYZ.UploadersLib.HelperClasses;
using System;
...
namespace ShareXYZ
{
    public static class TaskHelpers
    {
        ...
        public static void OpenScreenColorPicker(TaskSettings taskSettings = null)
        {
            ...
            if (pointInfo != null)
            {
                ...
                if (Program.MainForm.niTray.Visible)
                {
                    ...
                    Program.MainForm.niTray.ShowBalloonTip(3000, "ShareXYZ", string.Format(Resources.TaskHelpers_OpenQuickScreenColorPicker_Copied_to_clipboard___0_, text), ToolTipIcon.Info);
                }
            }
        }
        ...
        public static void OpenFTPClient()
        {
            if (Program.UploadersConfig != null && Program.UploadersConfig.FTPAccountList != null)
            {
                ...
                if (account != null)
                {
                    ...
                    {
                        MessageBox.Show(Resources.TaskHelpers_OpenFTPClient_FTP_client_only_supports_FTP_or_FTPS_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
            ...
            MessageBox.Show(Resources.TaskHelpers_OpenFTPClient_Unable_to_find_valid_FTP_account_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        public static void TweetMessage()
        {
                    ...
                    TaskEx.Run(() =>
                    {
                        using (TwitterTweetForm twitter = new TwitterTweetForm(twitterOAuth))
                        {
                            if (twitter.ShowDialog() == DialogResult.OK && twitter.IsTweetSent)
                            {
                                ...
                                {
                                    Program.MainForm.niTray.Tag = null;
                                    Program.MainForm.niTray.ShowBalloonTip(5000, "ShareXYZ - Twitter", Resources.TaskHelpers_TweetMessage_Tweet_successfully_sent_, ToolTipIcon.Info);
                                }
                            }
                        }
                    });
            ...
            MessageBox.Show(Resources.TaskHelpers_TweetMessage_Unable_to_find_valid_Twitter_account_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        public static bool ToggleHotkeys()
        {
            ...
            if (Program.MainForm.niTray.Visible)
            {
                ...
                Program.MainForm.niTray.ShowBalloonTip(3000, "ShareXYZ", balloonTipText, ToolTipIcon.Info);
            }
        ...
        public static bool CheckFFmpeg(TaskSettings taskSettings)
        {
            if (!File.Exists(taskSettings.CaptureSettings.FFmpegOptions.CLIPath))
            {
                ...
                if (MessageBox.Show(string.Format(Resources.ScreenRecordForm_StartRecording_does_not_exist, ffmpegText),
                    "ShareXYZ - " + Resources.ScreenRecordForm_StartRecording_Missing + " ffmpeg.exe", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
        ...
        private static void DownloaderForm_InstallRequested(string filePath)
        {
            ...
            if (result)
            {
                MessageBox.Show(Resources.ScreenRecordForm_DownloaderForm_InstallRequested_FFmpeg_successfully_downloaded_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show(Resources.ScreenRecordForm_DownloaderForm_InstallRequested_Download_of_FFmpeg_failed_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
