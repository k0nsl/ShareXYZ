...
namespace ShareXYZ
{
    public partial class ApplicationSettingsForm : BaseForm
    {
        ...
        private void ChangeLanguage(SupportedLanguage language)
        {
            ...
            if (loaded)
            {
                ...
                if (LanguageHelper.ChangeLanguage(Program.Settings.Language) &&
                    ...
                    "ShareXYZ", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                {
                    Program.Restart();
                }
            }
        ...
        {
            URLHelpers.OpenURL("https://github.com/ShareXYZ/ShareXYZ/wiki/Translation");
        }
        ...
        {
            Helpers.BrowseFolder(Resources.ApplicationSettingsForm_btnBrowsePersonalFolderPath_Click_Choose_ShareXYZ_personal_folder_path, txtPersonalFolderPath, Program.PersonalPath);
        }
