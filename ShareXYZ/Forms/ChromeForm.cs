...
namespace ShareXYZ
{
    public partial class ChromeForm : BaseForm
    {
        ...
        private void CreateChromeHostManifest(string filepath)
        {
            var manifest = new
            {
                name = "com.getShareXYZ.sharex",
                description = "ShareXYZ",
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(Resources.ChromeForm_btnRegister_Click_Chrome_support_enabled_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "ShareXYZ - " + Resources.Program_Run_Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnUnregister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(Resources.ChromeForm_btnUnregister_Click_Chrome_support_disabled_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "ShareXYZ - " + Resources.Program_Run_Error, MessageBoxButtons.OK, MessageBoxIcon.Error);
