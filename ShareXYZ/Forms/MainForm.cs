...
namespace ShareXYZ
{
    public partial class MainForm : HotkeyForm
    {
        ...
        private void AfterShownJobs()
        {
            ...
            {
                niTray.ShowBalloonTip(5000, "ShareXYZ", Resources.MainForm_AfterShownJobs_You_can_single_left_click_the_ShareXYZ_tray_icon_to_start_region_capture_, ToolTipIcon.Info);
        ...
        private void tsmiDeleteSelectedFile_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show(Resources.MainForm_tsmiDeleteSelectedFile_Click_Do_you_really_want_to_delete_this_file_,
                "ShareXYZ - " + Resources.MainForm_tsmiDeleteSelectedFile_Click_File_delete_confirmation, MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                uim.DeleteFiles();
                RemoveSelectedItems();
            }
