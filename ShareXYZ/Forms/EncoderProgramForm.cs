...
namespace ShareXYZ
{
    public partial class EncoderProgramForm : BaseForm
    {
        ...
        {
            Helpers.BrowseFile("ShareXYZ - " + Resources.EncoderProgramForm_btnPathBrowse_Click_Choose_encoder_path, txtPath);
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.EncoderProgramForm_btnOK_Click_Path_can_t_be_empty_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (string.IsNullOrEmpty(txtExtension.Text))
            {
                MessageBox.Show(Resources.EncoderProgramForm_btnOK_Click_Extension_can_t_be_empty_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
