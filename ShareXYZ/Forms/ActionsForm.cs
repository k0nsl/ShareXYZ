...
namespace ShareXYZ
{
    public partial class ActionsForm : BaseForm
    {
        ...
        {
            Helpers.BrowseFile("ShareXYZ - " + Resources.ActionsForm_btnPathBrowse_Click_Choose_file_path, txtPath);
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.ActionsForm_btnOK_Click_Name_can_t_be_empty_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            if (string.IsNullOrEmpty(txtPath.Text))
            {
                MessageBox.Show(Resources.ActionsForm_btnOK_Click_File_path_can_t_be_empty_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
