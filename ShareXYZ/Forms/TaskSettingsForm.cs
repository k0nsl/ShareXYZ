...
namespace ShareXYZ
{
    public partial class TaskSettingsForm : BaseForm
    {
        ...
        private void UpdateWindowTitle()
        {
            if (IsDefault)
            {
                Text = "ShareXYZ - " + Resources.TaskSettingsForm_UpdateWindowTitle_Task_settings;
            }
            else
            {
                Text = "ShareXYZ - " + string.Format(Resources.TaskSettingsForm_UpdateWindowTitle_Task_settings_for__0_, TaskSettings);
            }
        }
        ...
        {
            using (ImageEffectsForm imageEffectsForm = new ImageEffectsForm(ShareXYZResources.LogoBlack, TaskSettings.ImageSettings.ImageEffects))
            {
