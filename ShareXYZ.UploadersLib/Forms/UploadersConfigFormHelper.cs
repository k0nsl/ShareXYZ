    ...
    public partial class UploadersConfigForm
    {
        ...
        public void PhotobucketCreateAlbum()
        {
            ...
            if (pb.CreateAlbum(txtPhotobucketParentAlbumPath.Text, txtPhotobucketNewAlbumName.Text))
            {
                ...
                MessageBox.Show(string.Format(Resources.UploadersConfigForm_PhotobucketCreateAlbum__0__successfully_created_, albumPath), "ShareXYZ",
        ...
        public void MinusAuth()
        {
            if (!string.IsNullOrEmpty(txtMinusUsername.Text) && !string.IsNullOrEmpty(txtMinusPassword.Text))
            {
                ...
                {
                    MessageBox.Show(Resources.UploadersConfigForm_Error + ": " + ex.Message, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                finally
                {
        ...
        private void FTPOpenClient()
        {
            ...
            if (account != null)
            {
                ...
                {
                    MessageBox.Show(Resources.UploadersConfigForm_FTPOpenClient_FTP_client_only_supports_FTP_or_FTPS_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }

                return;
            }

            MessageBox.Show(Resources.UploadersConfigForm_FTPOpenClient_Unable_to_find_valid_FTP_account_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
