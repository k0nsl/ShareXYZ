...
- You can now authenticate to Jira", Links.URL_WEBSITE, "ShareXYZ", APIKeys.JiraConsumerKey, Jira.PublicKey);
            }
            catch (Exception e)
            {
        ...
        {
            MessageBox.Show(Resources.UploadersConfigForm_oAuthJira_RefreshButtonClicked_Refresh_authorization_is_not_supported_, "ShareXYZ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            if (MessageBox.Show("Remove all custom uploaders?", "ShareXYZ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
        ...
        {
            URLHelpers.OpenURL("https://github.com/ShareXYZ/ShareXYZ/wiki/Custom-Uploader");
        }

        private void btnCustomUploaderExamples_Click(object sender, EventArgs e)
        {
            URLHelpers.OpenURL("https://github.com/ShareXYZ/CustomUploaders");
        }
