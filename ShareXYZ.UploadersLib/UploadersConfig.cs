...
namespace ShareXYZ.UploadersLib
{
    public class UploadersConfig : SettingsBase<UploadersConfig>
    {
        ...
        public string DropboxUploadPath = "Public/ShareXYZ/%y/%mo";
        ...
        public string CopyUploadPath = "ShareXYZ/%y/%mo";
        ...
        public string EmailDefaultSubject = "Sending email from ShareXYZ";
